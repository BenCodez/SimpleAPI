...
public class PluginMessage implements PluginMessageListener {
    ...
    public void onPluginMessageReceived(String channel, Player player, byte[] message) {
        if (!channel.equals("bungee:channel")) { // Replace with your channel name
            return;
        }
    ...
    public void sendPluginMessage(String channel, String... messageData) {
        ...
        try {
            ...
            Bukkit.getServer().sendPluginMessage(plugin, "bungee:channel", byteOutStream.toByteArray()); // Replace with your channel name
