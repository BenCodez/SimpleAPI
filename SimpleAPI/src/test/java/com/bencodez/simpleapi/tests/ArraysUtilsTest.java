...
public class ArraysUtilsTest {
    ...
    public void colorizeArrayListReturnsColorizedList() {
        ...
        ArrayList<String> expected = new ArrayList<>(Arrays.asList("§1Hello", "§2World"));
    ...
    public void colorizeListReturnsColorizedList() {
        ...
        List<String> expected = Arrays.asList("§1Hello", "§2World");
        assertEquals(expected, ArrayUtils.colorize(input));
    }
    ...
    public void convertBaseComponentArrayListToArrayReturnsCorrectArray() {
        ArrayList<BaseComponent> input = new ArrayList<>(
                Arrays.asList(new TextComponent("Hello"), new TextComponent("World")));
    ...
    public void convertBaseComponentArrayToArrayListReturnsCorrectList() {
        ...
        ArrayList<BaseComponent> expected = new ArrayList<>(
                Arrays.asList(new TextComponent("Hello"), new TextComponent("World")));
    ...
    public void convertItemsCollectionToArrayReturnsCorrectArray() {
        Collection<ItemStack> input = Arrays.asList(new ItemStack(Material.DIAMOND),
