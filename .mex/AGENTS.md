---
name: agents
description: SimpleAPI project memory and authority boundary.
last_updated: 2026-09-20
---

# SimpleAPI memory

Root `AGENTS.md` defines the evidence hierarchy and MEX use. This Wiki records platform, packaging, and transport traps. MEX 0.8.2 does not index Java; verify implementation against current Java and tests. Use `ROUTER.md` to load only relevant context.
